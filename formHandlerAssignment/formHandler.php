...
//Model-Controller Area.  The PHP processing code goes in this area.
	...
	$inFavoriteClass = $_POST["favoriteClass"];
	$inDreamState = $_POST["dreamState"];
	$inDog = $_POST["dog"];
	$inCat = $_POST["cat"];
	$inOther = $_POST["other"];
	$inNone = $_POST["none"];
...
<p>Favorite Class: <?php echo $inFavoriteClass; ?></p>
<p>Dream State: <?php echo $inDreamState; ?></p>
<p>Pet: <?php echo $inDog . " " . $inCat . " " . $inOther . " " . $inNone; ?></p>
